...
The world_gdp data set used in research question one is from the World Bank. The data itself is reliable as it is collected and consolidated by the world bank, which is a global organisation run by the United Nations. The only limitation is some of the country names don't match the ones in the kiva dataset and there are no iso codes for easier correlation. Therefore the 
