...
The GDP data in the scatter plot above is from 2015, this year was used as it makes for the most accurate match up with the Kiva loan data which is from 2014 to 2017. The plot has clustering in the top left which initially made us suspect that a relationship exists between lower GDP per capita and higher amounts of loaned money. When attempting a curve fit of the data it was found however that there was no obvious relationship. What we can discern from the data is that it is right skewed, indicting that countries with lower GDP's per capita make up most of total loans. In these countries many people do not have access to financial services or banking all-together, this creates a need for them to use a charitable service like Kiva. And on the other hand, it is the goal of Kiva to provide such individuals with access to loans (Kiva About, 2023). Hence our data demonstrates the free market in action, those who live in countries with low GDP's need Kiva, and Kiva needs them. 
